  ...
  try {
    ...
    if (_0x2e869c.code) {
      ...
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://files.catbox.moe/n4fjap.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 2557847665XXXX");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://timnasa-md42.onrender.com/pair?phone=' + _0x4de0bb);
    ...
    await _0x50e2bb("> *✧TIMNASA TＭＤ✧ PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
