...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        ...
        let envSettings = `〔 *✧TIMNASA TMD✧* 〕
▸╭───────────
▸┃๏ *TIMNASA ENV SETTINGS 🗿*
▸└───────────···๏
╰────────────────┈⊷
╭━━〔 *Enabled Disabled* 〕━━┈⊷
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://files.catbox.moe/n4fjap.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/Next5x/TIMNASA_TMD2/raw/refs/heads/main/autovoice/menu.mp3' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
