...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x515443("> *NOW GROUP IS OPENED BY ✧TIMNASA TMD✧ BOT*");
    }, _0x57d309);
...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x5c514e("> *NOW GROUP CLOSED BY ✧TIMNASA TMD✧*");
    }, _0x4b2fe4);
...
cmd({
  ...
  try {
    ...
    let _0x14ad67 = "*TAGGING ALL ADMINS IN THE GROUP TIMNASA TMD2 🔳:*\n\n";
...
cmd({
  ...
  try {
    ...
    const _0x23264b = await _0x188ee4.sendMessage(_0x5a0744.chat, {
      'text': "*GROUP CHAT MUTED BY ✧FREDI MD✧* 🔒"
    }, {
      'quoted': _0x2926d7
    });
...
cmd({
  ...
  try {
    ...
    const _0x74b371 = await _0x298fe1.sendMessage(_0x2602ac.chat, {
      'text': "*GROUP CHAT UNMUTED BY ✧TIMNASA TMD✧* 🔒"
    }, {
      'quoted': _0x116d41
    });
