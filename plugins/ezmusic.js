...
cmd({
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("✧TIMNASA TMD✧: Spotify audio sent successfully.");
  } else if (youtubeSent) {
    reply("✧TIMNASA TMD✧: YouTube audio sent successfully.");
  }
});
